...
describe('Matrix', () => {
  it('should define matrix as a function', () => {
    expect(typeof matrix).toEqual('function')
  })

  it('should produce a 2x2 array, when calling matrix with ', () => {
    const m = matrix(2)
  ...
  it('should produce a 3x3 array, when calling matrix with ', () => {
    const m = matrix(3)
  ...
  it('should produce a 4x4 array, when calling matrix with ', () => {
    const m = matrix(4)
